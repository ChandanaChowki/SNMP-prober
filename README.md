...
This script is used to prober an SNMP agent and find the rate of change for several OIDs between successive probes/samples. The two simulators used to test this is reachable via 18.219.51.6 port 1611 and port 1612. Their community strings are 'public'.
